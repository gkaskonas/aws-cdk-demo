...
module.exports = {
  siteMetadata: {
    ...
    siteTitle: `Peter Kaskonas`,
    siteTitleAlt: `Peter Kaskonas - Solutions Architect`,
    siteHeadline: `Peter Kaskonas - Solutions Architect`,
    siteUrl: `https://peterkaskonas.com`,
    siteDescription: `AWS Solutions Architect for hire`,
    siteLanguage: `en`,
  ...
  plugins: [
    ...
    `gatsby-plugin-sitemap`,
    {
      ...
      options: {
        name: `gkaskonas - solutions architect`,
        short_name: `gkaskonas`,
